...
describe("Sistema de Análise de Crédito Imobiliário", function () {
    ...
    describe("Regra de Negócio: avaliarLocacao", function () {
        ...
        // CASO 7: TESTE DE BORDA - REPROVAÇÃO POR RENDA INSUFICIENTE
        it("deve REPROVAR se a renda for muito baixa (comprometimento > 35%) e fiador ruim (TESTE DE BORDA)", function () {
            // Aluguel 1000. Renda 2.857,14. Comprometimento 50%.
            dadosBase.analise_financeira.renda_mensal_comprovada = moneyFormat(2857.14 - 0.01);
            dadosBase.garantia.fiador.renda_fiador = moneyFormat(3000.0 - 0.01); // Fiador ruim
            dadosBase.analise_financeira.vinculo_empregaticio = "Autonomo"; // Sem CLT
        ...
        // CASO 8: TESTE DE BORDA - FIADOR FRACO
        it("deve penalizar o score se o Fiador não tiver renda de 3x o pacote (TESTE DE BORDA)", function () {
            // Aluguel 1000. Fiador ganha 2999,99 (2x apenas, 3000,00 - 0,01).
            dadosBase.garantia.fiador.renda_fiador = "R$ 2.999,99";
        ...
        // CASO 9: TESTE DE BORDA - RENDA NO LIMITE (30% a 35%)
        it("deve aprovar COM RESSALVAS se a renda estiver no limite (entre 30% e 35%) (TESTE DE BORDA)", function () {
            // Aluguel 1000. Renda 2.857,14 + 0,01. Comprometimento = 35.0%
            dadosBase.analise_financeira.renda_mensal_comprovada = "R$ 2.857,15";
